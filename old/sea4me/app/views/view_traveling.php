...
<div class="box">
    <div class="top"></div>
    <ul class="subnav">
        <li class="active"><a href="<?php echo base_url(); ?>func/currentTrips"><?php echo translate("Current Trips"); ?></a></li>
        <li><a href="<?php echo base_url(); ?>func/upcommingTrips"><?php echo translate("Upcoming Trips"); ?></a></li>
        <li><a href="<?php echo base_url(); ?>func/previousTrips"><?php echo translate("Previous Trips"); ?></a></li>
        <li class="starred"><a href="<?php echo base_url(); ?>func/starredItem?starred=true"><?php echo translate("Starred Items"); ?></a></li>
    </ul>
    <div class="middle">
