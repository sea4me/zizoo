...
function print_reservation() {
 ...
 <div class="middle clsDes_Top_Spac" id="TrCurrents_Tips_Blk">
  <div class="clsDisign_Box">
   ...
   <div class="CenterPannel">
     <div class="clsH1_long_Border">
      <p>
      <h1><?php echo translate("Current Trips"); ?></h1>
      </p>
     </div>
					
					<?php if($result->num_rows() > 0) { ?>
					
						<p style="margin:10px 0 0;" class="text_right"><span class="View_MyPrint"> <a href="javascript:void(0);" onclick="javascript:print_reservation();"><?php echo translate("Print this page"); ?></a> </span></p>
    ...
    <tr>
			 ...
			 <td width="15%">
				<?php if (strtotime($row->checkout) <= strtotime(date('m/d/Y')) ) { ?>
   ...
   <?php } ?>
      ...
      <div id="searching"> 
       ...
       <br>
       <input value="Where are you going?" onclick="clear_location(this);" type="text" class="location rounded_left" autocomplete="off" id="location" style="width:250px;float:left; margin-right:10px;" name="location" />
