<?php
	...
	function facebook_id($who = 'me')
	{
		...
		return $ci->facebook->append_token($ci->config->item('facebook_api_url').$who.'/id');
	}
	...
	function facebook_email($who = 'me')
	{
		...
		return $ci->facebook->append_token($ci->config->item('facebook_api_url').$who.'/email');
	}
	...
	function facebook_work($who = 'me')
	{
		...
		return $ci->facebook->append_token($ci->config->item('facebook_api_url').$who.'/work');
	}
	...
	function facebook_live($who = 'me')
	{
		...
		return $ci->facebook->append_token($ci->config->item('facebook_api_url').$who.'/hometown');
	}
