...
?>
    ...
    <div class="middle clsDes_Top_Spac" id="TrUpcome_Blk">
        ...
        <div class="CenterPannel">
				<div id="upcomes">
										<div class="clsH1_long_Border"><p><h1><b><?php echo translate("Upcoming Trips"); ?></b></h1></p>	</div>						 		 
    ...
    <tr>
			 ...
			 <td>
				<?php if (strtotime($row->checkin) == strtotime(date('m/d/Y')) ) { ?>
				 <p class="clsBold"><?php echo anchor('travelling/checkin/'.$row->id,translate("Checkin"),array('id' => 'checkin'));  ?></p>
				<?php } ?>
