 ...
 <a class="filter_toggle"></a>
  ...
  <ul class="search_filter_content">
    <li class="clearfix">
      ...
      <input type="checkbox" <?php if(is_array($room_types) > 0) { if(in_array('Entire home/apt',$room_types)) echo 'checked="checked"'; } ?> value="Entire home/apt" name="room_types[]" id="room_type_0">
    ...
    <li class="clearfix">
      ...
      <input type="checkbox" <?php if(is_array($room_types) > 0) { if(in_array('Private room',$room_types)) echo 'checked="checked"'; } ?> value="Private room" name="room_types[]" id="room_type_1">
      ...
      <input type="checkbox" <?php if(is_array($room_types) > 0) { if(in_array('Shared room',$room_types)) echo 'checked="checked"'; } ?> value="Shared room" name="room_types[]" id="room_type_2">
